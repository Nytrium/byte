...
class Moderation(commands.Cog):
    ...
    async def _help(self, ctx):
        ...
        embed.add_field(name="8ball", value="Say something and find out the possibilities of that happening!",
                        inline=False)  # 8ball
        ...
        embed.add_field(name="user-info", value="Get some information about a specific user.",
                        inline=False)  # User-info
